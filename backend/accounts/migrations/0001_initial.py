    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('customer', 'Customer'), ('producer', 'Producer'), ('admin', 'Admin')], default='customer', max_length=10)),
                ...
                ('minimum_order_value', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Minimum order subtotal required for this producer (0 = no minimum).', max_digits=10)),
                ('is_producer', models.BooleanField(default=False)),
                ('customer_role', models.CharField(blank=True, choices=[('individual', 'Individual'), ('community_group', 'Community Group'), ('restaurant', 'Restaurant')], default=None, max_length=20, null=True)),
