    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('CUSTOMER', 'Customer'), ('PRODUCER', 'Producer')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('account_type', models.CharField(choices=[('INDIVIDUAL', 'Individual'), ('COMMUNITY', 'Community'), ('RESTAURANT', 'Restaurant')], default='INDIVIDUAL', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store_contact_phone', models.CharField(blank=True, max_length=20)),
                ('store_address', models.TextField(blank=True, default='')),
                ('store_postcode', models.CharField(blank=True, default='', max_length=20)),
